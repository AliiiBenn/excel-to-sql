...
Detailed release notes and breaking changes are available on GitHub.

Visit the [GitHub releases page](https://github.com/wareflowx/excel-to-sql/releases) for version history and release notes.
